...
interface AddOAuthDialogProps {
  ...
  onConfirm: (selectedId: 'google' | 'github' | 'discord' | 'linkedin' | 'twitter') => void;
  enabledProviders: Record<'google' | 'github' | 'discord' | 'linkedin' | 'twitter', boolean>;
}
...
export function AddOAuthDialog({
  ...
  const [selectedId, setSelectedId] = useState<
    'google' | 'github' | 'discord' | 'linkedin' | 'twitter' | null
  >(null);
  ...
  const selectProvider = (id: 'google' | 'github' | 'discord' | 'linkedin' | 'twitter') => {
    setSelectedId(id);
  };
